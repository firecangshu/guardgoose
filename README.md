...
**护院鹅** 是一套基于 **CSI（信道状态信息）** 的非接触式居家安全守护系统，通过分析 CSI 信号穿过人体产生的扰动，实现：
...
9. 监控运维图 · 10. 隐私边界图 · 11. 版本演进路线图 · 12. 测试与功耗图
13. 初赛开发时序计划甘特图
